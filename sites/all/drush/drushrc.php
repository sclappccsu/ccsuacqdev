 ...
 */
# $options['include'file:///C|/ProgramData/Drush/examples/] = array('/path/to/commands','/path2/to/more/commands');
...
$options['dev'] = array('/c/Users/sc4429/Documents/drupal/acquia');
...
#if (!empty($output)) {
#  $repo = $output[0];
#  $options['config'file:///C|/ProgramData/Drush/examples/] = $repo . '/drush/drushrc.php';
#  $options['include'file:///C|/ProgramData/Drush/examples/] = $repo . '/drush/commands';
